...
function Form() {
    ...
    const HandleChase = (e : React.ChangeEvent<HTMLInputElement, HTMLInputElement>)  => {
    ...
    const HandleSubmit = (e: React.ChangeEvent<HTMLInputElement, HTMLInputElement>) => {
        e.preventDefault();
  ...
  return (
    ...
    <form action="" className="space-y-5">
        ...
        <input type="submit" onChange={HandleSubmit} disabled={Validacion} value={'Definicion Del Dinero'} className="w-full border bg-white p-2 tracking-widest font-black cursor-pointer disabled:opacity-30  " />
    </form>
    </>
  )
}
