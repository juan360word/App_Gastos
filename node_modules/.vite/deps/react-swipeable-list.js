import { n as __commonJSMin, t as require_react } from "./react-TUYU05Ph.js";
...
//#endregion
//#region node_modules/react-swipeable-list/dist/react-swipeable-list.umd.js
var require_react_swipeable_list_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require_react(), require_prop_types()) : typeof define === "function" && define.amd ? define([
			"exports",
			"react",
			"prop-types"
		], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["react-swipeable-list"] = {}, global.React, global.PropTypes));
	})(exports, (function(exports$1, React, PropTypes) {
		"use strict";
		...
		var LeadingActions = function LeadingActions(_ref) {
			...
			if (Array.isArray(children)) return React__default["default"].Children.map(children, function(child, index) {
		...
		function _inherits(subClass, superClass) {
			...
			Object.defineProperty(subClass, "prototype", {
				value: Object.create(superClass && superClass.prototype, { constructor: {
					value: subClass,
					writable: true,
					configurable: true
				} }),
			...
			_createClass(SwipeableList, [{
				...
				value: function clickedItem(itemId) {
					...
					Object.keys(this.itemsMap).forEach(function(listItem) {
						if (listItem !== itemId) _this2.itemsMap[listItem]();
					});
				}
			}, {
				key: "render",
		...
		var SwipeableListItem = /* @__PURE__ */ function(_PureComponent) {
			...
			function SwipeableListItem(props) {
				...
				_defineProperty(_assertThisInitialized(_this), "handleDragStart", function(_ref) {
					...
					if (_this.props.clickedCallback) _this.props.clickedCallback(_this.id);
					if (!_this.leadingActionsOpened && !_this.trailingActionsOpened) {
						_this.resetState();
						_this.setState(initialState);
					}
					var startOffsetX = 0;
					if (_this.leadingActionsOpened) startOffsetX = -_this.leadingActionsWidth;
					if (_this.trailingActionsOpened) startOffsetX = _this.trailingActionsWidth;
					_this.dragStartPoint = {
						x: clientX + startOffsetX,
						y: clientY
					};
					_this.listElement.className = "swipeable-list-item__content";
					if (_this.leadingActionsElement) _this.leadingActionsElement.className = "swipeable-list-item__leading-actions";
					if (_this.trailingActionsElement) _this.trailingActionsElement.className = "swipeable-list-item__trailing-actions";
				...
				_defineProperty(_assertThisInitialized(_this), "handleMouseMove", function(event) {
					if (_this.dragStartedWithinItem()) {
						...
						if (_this.isSwiping()) {
							...
							if (newLeft > 0) _this.left = Math.min(newLeft, _this.maxSwipeThreshold);
							else _this.left = Math.max(newLeft, -_this.maxSwipeThreshold);
							_this.scheduleUpdatePosition();
						}
					}
				});
				...
				_defineProperty(_assertThisInitialized(_this), "playReturnAnimationForLeadingActions", function(_ref2) {
					...
					if (_this.leadingActionsElement) {
						...
						if (_this.leadingActionsOpened && isIosType && to !== 0) _this.leadingActionsElement.className += " test-actions-opened";
						if (playMsReturnAnimation) _this.leadingActionsElement.addEventListener("animationend", function keepAnimationEnd() {
							_this.leadingActionsElement.removeEventListener("animationend", keepAnimationEnd);
							_this.leadingActionsElement.style.width = 0;
						});
						else _this.leadingActionsElement.style.width = "".concat(to === 0 || !isIosType ? 0 : _this.leadingActionsOpened && isIosType ? _this.leadingActionsWidth : 0, "px");
					}
				});
				_defineProperty(_assertThisInitialized(_this), "playReturnAnimationForTrailingActions", function(_ref3) {
					...
					if (_this.trailingActionsElement) {
						...
						if (_this.trailingActionsOpened && isIosType && to !== 0) _this.trailingActionsElement.className += " test-actions-opened";
						if (!playMsReturnAnimation) _this.trailingActionsElement.style.width = "".concat(to === 0 || !isIosType ? 0 : _this.trailingActionsOpened && isIosType ? _this.trailingActionsWidth : 0, "px");
						else _this.trailingActionsElement.addEventListener("animationend", function keepAnimationEnd() {
				...
				_defineProperty(_assertThisInitialized(_this), "playReturnAnimation", function() {
					var _ref4$to = (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}).to, to = _ref4$to === void 0 ? 0 : _ref4$to;
					if (_this.left === 0) return;
					var listElement = _assertThisInitialized(_this).listElement;
					...
					if (playMsReturnAnimation) listElement.addEventListener("animationend", function keepAnimationEnd() {
					...
					if (listElement) {
						...
						if (!playMsReturnAnimation) listElement.style.transform = "translateX(".concat(isIosType ? to : 0, "px)");
					}
					if (_this.left < 0) _this.playReturnAnimationForTrailingActions({
						to,
						isIosType,
						playMsReturnAnimation
					});
					else _this.playReturnAnimationForLeadingActions({
						to,
						isIosType,
						playMsReturnAnimation
					});
				...
				_defineProperty(_assertThisInitialized(_this), "playActionAnimation", function(_ref5) {
					var type = _ref5.type;
					if (_assertThisInitialized(_this).listElement) switch (type) {
						case ActionAnimation.REMOVE:
							_this.playRemoveAnimation();
							break;
						case ActionAnimation.NONE: break;
						default: _this.playReturnAnimation();
					}
				});
				_defineProperty(_assertThisInitialized(_this), "handleDragEnd", function() {
					...
					if (_this.isSwiping()) {
						...
						if (onSwipeEnd) onSwipeEnd(_this.dragDirection);
						if (triggerAction) {
							if (leadingFullSwipe) {
						...
						if (_this.leadingActionsOpened || _this.trailingActionsOpened) {
							if (_this.leadingActionsOpened) _this.left = _this.leadingActionsWidth;
							else if (_this.trailingActionsOpened) _this.left = -_this.trailingActionsWidth;
							_this.playReturnAnimation({ to: _this.left });
						} else {
				...
				_defineProperty(_assertThisInitialized(_this), "setDragDirection", function(x, y) {
					if (_this.dragDirection === DragDirection.UNKNOWN) {
						...
						if (horizontalDistance <= _this.dragHorizontalDirectionThreshold && verticalDistance <= _this.dragVerticalDirectionThreshold) return;
						var angle = Math.atan2(y - startY, x - startX);
						switch (Math.round(8 * angle / (2 * Math.PI) + 8) % 8) {
							case 0:
								if (_this.leadingActionsElement !== null && horizontalDistance > _this.dragHorizontalDirectionThreshold) _this.dragDirection = DragDirection.RIGHT;
								break;
							case 1:
							case 2:
							case 3:
								if (verticalDistance > _this.dragVerticalDirectionThreshold) _this.dragDirection = DragDirection.DOWN;
								break;
							case 4:
								if (_this.trailingActionsElement !== null && horizontalDistance > _this.dragHorizontalDirectionThreshold) _this.dragDirection = DragDirection.LEFT;
								break;
							case 5:
							case 6:
							case 7:
								if (verticalDistance > _this.dragVerticalDirectionThreshold) _this.dragDirection = DragDirection.UP;
								break;
							default: _this.dragDirection = DragDirection.UNKNOWN;
						}
						var onSwipeStart = _this.props.onSwipeStart;
						if (onSwipeStart && _this.isSwiping()) onSwipeStart(_this.dragDirection);
					}
				});
				...
				_defineProperty(_assertThisInitialized(_this), "scheduleUpdatePosition", function() {
					if (_this.requestedAnimationFrame) return;
				...
				_defineProperty(_assertThisInitialized(_this), "updatePosition", function() {
					...
					if (Date.now() - _this.startTime <= FPS_INTERVAL) return;
					...
					if (isSwipingLeft) {
						if (_this.onlyLeadingActions) _this.left = 0;
					...
					if (isSwipingRight) {
						if (_this.onlyTrailingActions) _this.left = 0;
						if (_this.leadingActionsElement && listType === Type.IOS) {
							_this.leadingActionsOpened = _this.left > _this.leadingActionsWidth;
							_this.trailingActionsOpened = false;
						}
					}
					if (_this.leadingActionsElement) _this.leadingActionsElement.style.width = "".concat(_this.left < 0 ? 0 : _this.left, "px");
					if (_this.trailingActionsElement) _this.trailingActionsElement.style.width = "".concat(_this.left > 0 ? 0 : -_this.left, "px");
					if (_this.listElement) {
						if (fullSwipe) {
							var threshold = _assertThisInitialized(_this).listElement.offsetWidth * fullSwipeThreshold;
							if (_this.left < -threshold) _this.setState({
								leadingFullSwipe: false,
								trailingFullSwipe: true,
								triggerAction: true,
								scaleTrailing: true
							});
							else if (_this.left > threshold) _this.setState({
				...
				_defineProperty(_assertThisInitialized(_this), "onActionTriggered", function(isDestructive) {
					_this.playActionAnimation({ type: isDestructive ? ActionAnimation.REMOVE : ActionAnimation.RETURN });
				});
				...
				_defineProperty(_assertThisInitialized(_this), "renderActions", function(actions, type, binder) {
					...
					return /* @__PURE__ */ React__default["default"].createElement("div", {
						...
						ref: binder
					}, /* @__PURE__ */ React__default["default"].createElement(ItemContext.Provider, { value: {
						actionDelay,
						destructiveCallbackDelay,
						listType,
						leadingFullSwipe,
				...
				_defineProperty(_assertThisInitialized(_this), "handleClick", function(event) {
					if (_this.props.onClick) {
						...
						if (Math.abs(event.clientX - _this.dragStartPoint.x) > 10) {
							event.preventDefault();
							return;
						}
						_this.props.onClick();
			...
			_createClass(SwipeableListItem, [
				...
				},
				{
					key: "fullSwipe",
					get: function get() {
						var _this$props3 = this.props, fullSwipe = _this$props3.fullSwipe;
						if (_this$props3.listType === Type.IOS) return fullSwipe;
						return true;
					}
				},
				{
					...
					value: function componentDidMount() {
						if (!this.props.optOutMouseEvents) this.listElement.addEventListener("mousedown", this.handleDragStartMouse);
						this.listElement.addEventListener("touchstart", this.handleDragStartTouch, { passive: true });
						...
						if (this.leadingActionsElement) this.leadingActionsWidth = measure(this.leadingActionsElement, function(el) {
							return el.offsetWidth;
						});
						if (this.trailingActionsElement) this.trailingActionsWidth = measure(this.trailingActionsElement, function(el) {
							return el.offsetWidth;
						});
						if (this.props.resetState) this.props.resetState(this.playReturnAnimation);
						if (this.props.maxSwipe) this.maxSwipeThreshold = this.props.maxSwipe * this.listElement.offsetWidth;
						else this.maxSwipeThreshold = this.listElement.offsetWidth;
					}
				},
				{
					...
					value: function componentWillUnmount() {
						...
						if (!this.props.optOutMouseEvents) this.listElement.removeEventListener("mousedown", this.handleDragStartMouse);
		...
		var SwipeAction = function SwipeAction(_ref) {
			...
			var onHandleClick = React__default["default"].useCallback(function() {
				...
				onActionTriggered(destructive);
				if (destructive) window.setTimeout(function() {
					return onClick();
				}, destructiveCallbackDelay);
				else onClick();
			}, [
			...
			React__default["default"].useEffect(function() {
				if (leading && main) setLeadingFullSwipeAction(onHandleClick);
			}, [
				leading,
				main,
				onHandleClick,
			...
			React__default["default"].useEffect(function() {
				if (trailing && main) setTrailingFullSwipeAction(onHandleClick);
			}, [
				trailing,
				main,
				onHandleClick,
		...
		exports$1.LeadingActions = LeadingActions;
		exports$1.SwipeAction = SwipeAction;
		exports$1.SwipeableList = SwipeableList;
		exports$1.SwipeableListItem = SwipeableListItem;
		exports$1.TrailingActions = TrailingActions;
		exports$1.Type = Type;
		Object.defineProperty(exports$1, "__esModule", { value: true });
	}));
}));
//#endregion
export default require_react_swipeable_list_umd();
