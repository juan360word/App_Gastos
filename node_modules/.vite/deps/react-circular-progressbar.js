...
//#region node_modules/react-circular-progressbar/dist/index.esm.js
...
var CircularProgressbar = function(_super) {
	...
	CircularProgressbar.prototype.getPathRatio = function() {
		...
		return (Math.min(Math.max(value, minValue), maxValue) - minValue) / (maxValue - minValue);
	};
	CircularProgressbar.prototype.render = function() {
		...
		return (0, import_react.createElement)("svg", {
		...
		}, this.props.background ? (0, import_react.createElement)("circle", {
			className: classes.background,
			style: styles.background,
			cx: VIEWBOX_CENTER_X,
			cy: VIEWBOX_CENTER_Y,
			r: VIEWBOX_HEIGHT_HALF
		}) : null, (0, import_react.createElement)(Path, {
			...
			strokeWidth,
			style: styles.path
		}), text ? (0, import_react.createElement)("text", {
...
function CircularProgressbarWithChildren(props) {
	props.children;
	var circularProgressbarProps = __rest(props, ["children"]);
	return (0, import_react.createElement)("div", { "data-test-id": "CircularProgressbarWithChildren" }, (0, import_react.createElement)("div", { style: {
		position: "relative",
		width: "100%",
		height: "100%"
	} }, (0, import_react.createElement)(CircularProgressbar, __assign({}, circularProgressbarProps)), props.children ? (0, import_react.createElement)("div", {
...
function buildStyles(_a) {
	...
	return {
		...
		background: removeUndefinedValues({ fill: backgroundColor })
	};
}
